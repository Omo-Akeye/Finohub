...
export default function Nav({isModalOpen,setIsModalOpen}) {
  return (
    ...
    <div className='flex justify-between xl:w-[90%] m-auto text-[#F8F8F8] items-center'>
      <div >
          <a href="#"><img src="/assets/Logo Name.svg" alt=""  className='w-[80%] md:w-full'/></a>
      </div>
      ...
      <div className='bg-primary rounded-[8px] text-black px-8 py-4 hidden md:flex cursor-pointer hover:bg-[#BBCF17]'>Join FinoHub</div>
