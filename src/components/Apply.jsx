    ...
    <div className='grid md:grid-cols-2 xl:gap-28 gap-14 lg:mt-[10rem] relative mt-20 xl:w-[90%] p-5 m-auto w-full'>
        <section>
            ...
            <ul className='line relative' data-aos="fade-up">
                <li className='flex'>
                    <div className='rounded-full bg-primary font-semibold text-2xl lg:w-16 lg:h-14 h-12 w-16 px-3 sm:w-12  text-center pt-3 z-10 md:w-16'>1</div>
                ...
                <li className='flex my-6'>
                    <div className='rounded-full bg-[#F8F8F8] font-semibold text-2xl lg:w-16 lg:h-14  h-12 w-16 sm:w-12 sm:h-14  px-3 text-center pt-3 z-10 md:w-16'>2</div>
                ...
                <li className='flex'>
                    <div className='rounded-full bg-[#F8F8F8] font-semibold text-2xl lg:w-16 lg:h-14  h-12 w-16 sm:w-12  px-3 text-center pt-3 z-10 md:w-16'>3</div>
                    <div className='rounded-lg lg:py-6 md:px-8 p-3 ml-6'>
